...
public class Event {
    ...
    public void saveNewEvent() {
        ...
        String infoQuery = "INSERT INTO EventInfos (event_id, numGuests) VALUES (?, ?)";
        int numGuests = 0;
        PersistenceManager.executeUpdate(infoQuery, id, numGuests);

        LOGGER.info("Created EventInfo for event ID: " + id + " with numGuests: " + numGuests);

        infoQuery = "INSERT INTO StaffEventInfos (event_id, numbers_of_wait_staff, numbers_of_kitchen_staff) VALUES (?, ?, ?)";
        int numbersOfWaitStaff = 0; 
        int numberOfKitchenStaff = 0; 
        PersistenceManager.executeUpdate(infoQuery, id, numbersOfWaitStaff, numberOfKitchenStaff);
        LOGGER.info("Created StaffEventInfo for event ID: " + id);
    }
